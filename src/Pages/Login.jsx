...
//       // Make GET request for validation
...
//         {/* SIGN UP */}
//         <div
//           className={`${styles.col} ${styles.alignItemsCenter} ${styles.flexCol} ${styles.signUp}`}
//         >
...
//                     name="phone"
//                     pattern="[0-9]{11}"
//                     title="Invalid format 03214567890"
//                     required
...
//         {/* SIGN IN */}
//         <div
//           className={`${styles.col} ${styles.alignItemsCenter} ${styles.flexCol} ${styles.signIn}`}
//         >
//           <div className={`${styles.formWrapper} ${styles.alignItemsCenter}`}>
...
//                         height="30"
//                         fill="#c41b31"
//                         class="bi bi-facebook footer-svg-colour1"
//                         viewBox="0 0 16 16"
//                       >
...
//                         height="30"
//                         fill="#c41b31"
//                         class="bi bi-twitter footer-svg-colour1"
//                         viewBox="0 0 16 16"
//                       >
...
//                         height="30"
//                         fill="#c41b31"
//                         class="bi bi-instagram footer-svg-colour1"
//                         viewBox="0 0 16 16"
//                       >
...
//         {/* SIGN IN CONTENT */}
//         <div
//           className={`${styles.col} ${styles.alignItemsCenter} ${styles.flexCol}`}
//         >
